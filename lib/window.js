...
function Window(app, args) {
  ...
  this.on('resize', function(ev) {
    ...
    this.requestAnimationFrame(() => {
      ...
      //rootLayout.setFlexDirection(Yoga.FLEX_DIRECTION_COLUMN);
      //rootLayout.setPadding(Yoga.EDGE_ALL, 5);
      rootLayout.calculateLayout();
      this.document.body.render(this);
    });
  });
  ...
  this.on('expose', ev => {
    ...
    this.document.body.render(this, ev);
  });
