...
// TODO deprecate
// TODO replace with standard canvas api
//RC.fillRect = function(x, y, w, h, r, g, b, a) {
//  this.Render.FillRectangles(1, this.picture.id, [r, g, b, a], [x, y, w, h])
//};
...
RC.bezierCurveTo = function(x1, y1, x2, y2, x, y) {
  ...
  // TODO: calculate t step based on bounding box size
...
RC.fill = function() {
  ...
  // TODO: perf: use shape bounding boxinstead of compositing over whole width x height canvas
...
RC.drawImage = function(image, sx, sy, sWidth, sHeight, dx, dy, dWidth, dHeight) {
  ...
  if (image.constructor == RenderingContext2d) {
    ...
    this.Render.Composite(3, picture.id, 0, this.picture.id, 0, 0, 0, 0, 0, 0, this.width, this.height);
  }
};
