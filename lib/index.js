...
function Window(display, args)
{
    ...
    this.on('event', function(ev) {
        ...
        switch(ev.type) {
            ...
            case 22:
                ...
                break;
            case 17:
                this.emit('destroy', ntkev);
                break;
            case 12:
                this.emit('expose', ntkev);
                break;
            case 20:
                this.emit('maprequest', ntkev);
                break;
            case 23:
                this.emit('configurerequest', ntkev);
                break;
            default:
                console.log(ev);
        }
    ...
    var name2mask = {
        ...
        'maprequest': x11.eventMask.SubstructureRedirect,
        'configurerequest': x11.eventMask.SubstructureRedirect,
