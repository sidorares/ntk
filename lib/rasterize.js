...
//
// Takes opentype.js path commands (y-down coordinates, origin at the glyph
// baseline) and produces an antialiased 8-bit alpha bitmap suitable for
// XRender AddGlyphs. Non-zero winding rule, 4x4 supersampling.

const SS = 4; // supersampling factor per axis

/**
 * @param {Array} commands opentype.js path commands ({type: M|L|Q|C|Z, ...})
