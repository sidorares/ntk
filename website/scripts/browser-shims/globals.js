...
// Buffer and process globals that the ntk / node-x11 client/server code
// expects. They are installed on globalThis (not bundle-scoped) on purpose
// so the runner page can tweak process.env.DISPLAY before demo code runs.
